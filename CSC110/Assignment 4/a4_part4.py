...
def rsa_verify_simple(public_key: tuple[int, int],
    ...
    True
    >>> rsa_verify_simple((1357,1043), 'Cryptography is cool', 1129)
    False
    """
...
def test_collision_simple() -> None:
    ...
    m2 = 'abcdefghijklmnopqrst'  # FILL THIS IN
...
def len_times_sum(message: str) -> int:
    ...
    - message != ''
    """
    return len(message) * sum(ord(m) for m in message)
...
def ascii_to_int(message: str) -> int:
    ...
    this file.
    """
    ascii_lst = [ord(m) for m in message]
    return a4_part3.base128_to_int(ascii_lst)
