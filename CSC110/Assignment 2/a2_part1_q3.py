...
#
#     All there strings must be the same length, while s1 == s2 + s3 and the three cannot be all empty string.
#     This is unreachable!
#     """
#     s1 = ...
#     s2 = ...
...
def test_branch_3_unreachable(s1: str, s2: str, s3: str) -> None:
    ...
    This test shows no matter what s1, s2 or s3 are, the return value is never 3.
    This suggests that branch 3 is never equal to 3
    """
    assert mystery_3(s1, s2, s3) != 3
