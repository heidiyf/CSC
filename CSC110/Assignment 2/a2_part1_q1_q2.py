...
def mystery_1a_nested(x: list[int], y: list[int]) -> list[int]:
    """Mystery 1a.
    >>> mystery_1a_nested([1,2,3],[4,5,6])
    [1, 2, 3]

    >>> mystery_1a_nested([1,2,3], [4])
    [4, 1, 2, 3]

    >>> mystery_1a_nested([4], [1,2,3])
    [4, 1, 2, 3]
    """
...
def mystery_1b_nested(n: int, nums: set[int]) -> int:
    """Mystery 1b.
    >>> mystery_1b_nested(1, [1,2,3,4,5])
    0
    >>> mystery_1b_nested(4, [1,2,3,4,5])
    15
    >>> mystery_1b_nested(3,[1,2,3,4,5])
    18
    >>> mystery_1b_nested(6,[1,2,3,4,5])
    5
    """
    if n < len(nums):
        if n == 1:
...
def mystery_2a_no_if(x: int, y: int) -> bool:
    ...
    """
    return (x < y and 2 * x < y) or (2 * y > x > y)
