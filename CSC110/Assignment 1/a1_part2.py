...
def format_name_and_number(given_name: str, family_name: str, phone_number: int) -> str:
    ...
    >>> format_name_and_number('Heidi', 'Wang', 6047285260)
    'WANG, Heidi: 6047285260'
    """
...
def get_vowel_locations(s: str) -> list:
    ...
    >>> get_vowel_locations('AEIOU')
    [False, False, False, False, False]
    >>> get_vowel_locations('aeiou')
    [True, True, True, True, True]
    """
    return [x in {'a', 'e', 'i', 'o', 'u'} for x in s]
...
def get_divisibility_dict(numbers: set, divisor: int) -> dict:
    ...
    True
    >>> get_divisibility_dict({21, 29, 35}, 7) == {21: True, 29: False, 35: True}
    True
    """
